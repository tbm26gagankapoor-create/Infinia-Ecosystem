...
|---|---|:---:|:---:|:---:|:---:|:---:|
| **Multi-Model API** | Single API endpoint to access multiple open-source model families (LLaMA, DeepSeek, Mistral, Qwen, Command R) without managing separate integrations. | :white_check_mark: 40+ models | :white_check_mark: 150+ models | :white_check_mark: 80+ models | Limited ~20 models | :white_check_mark: 300+ (open + proprietary) |
| **OpenAI-Compatible Endpoints** | Drop-in replacement for the OpenAI API (`/v1/chat/completions`, `/v1/embeddings`, `/v1/models`), enabling migration with zero code changes. ~98% of developers already know this interface. | :white_check_mark: | :white_check_mark: | :white_check_mark: | :white_check_mark: | :white_check_mark: |
