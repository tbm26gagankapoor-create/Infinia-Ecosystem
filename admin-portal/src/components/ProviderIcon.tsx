...
export const PROVIDER_MAP: Record<string, { icon: IconComponent; bg: string; fg: string }> = {
  ...
  MBZUAI:   { icon: Anthropic as unknown as IconComponent, bg: '#1A1A2E', fg: '#ffffff' },
  TII:      { icon: Anthropic as unknown as IconComponent, bg: '#2C3E50', fg: '#ffffff' },
  Alibaba:  { icon: Qwen as unknown as IconComponent,     bg: '#FF6A00', fg: '#ffffff' },
}
