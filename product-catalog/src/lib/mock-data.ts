...
export const PRODUCTS: Product[] = [
  ...
  // ── L1: SECURE FOUNDATION ──────────────────────────────────

  {
    id: 'prod-hci',
    name: 'Infinia HCI',
    shortName: 'HCI',
    description: 'Hyperconverged infrastructure platform that unifies compute, storage, and networking into a single sovereign stack — the physical bedrock underpinning every Infinia deployment.',
    ...
    tags: ['infrastructure', 'hyperconverged', 'compute', 'storage', 'sovereign'],
    ...
    relatedProductIds: ['prod-corerun', 'prod-c3'],
    documents: [],
...

  {
    ...
    name: 'CoreRun',
    shortName: 'CoreRun',
    description: 'Sovereign container orchestration and runtime platform — a fully on-premise alternative to public cloud Kubernetes services, built for regulated industries and data-residency mandates.',
    mission: 'Give enterprises the power of cloud-native orchestration with the sovereignty of on-premise control.',
    icon: '⚙️',
    phase: 'ga',
    status: 'active',
    layer: 'l1',
    ...
    websiteUrl: 'https://infinia.ai/',
    tags: ['kubernetes', 'containers', 'orchestration', 'sovereign', 'on-premise'],
    keyFeatures: ['Managed Kubernetes clusters', 'Multi-tenancy', 'GitOps workflows', 'Policy as code', 'Air-gapped deployment'],
    techStack: ['Go', 'Kubernetes', 'containerd', 'Helm', 'ArgoCD'],
    relatedProductIds: ['prod-hci', 'prod-corerun-aigw'],
    documents: [],
    ...
    updates: [
      ...
      { date: '2026-02-14', title: 'Air-gapped installer', type: 'feature', description: 'Complete air-gapped deployment package for isolated government networks.' },
  ...
  {
    id: 'prod-c3',
    name: 'C3 Cyber Command Center',
    shortName: 'C3',
    description: 'Unified cyber command centre providing real-time threat intelligence, SOC automation, and sovereign security operations — the nerve centre for enterprise cyber defence.',
    ...
    websiteUrl: 'https://infinia.ai/',
    tags: ['security', 'soc', 'threat-intelligence', 'compliance', 'cyber'],
    keyFeatures: ['Real-time threat intelligence', 'SOC automation', 'SIEM integration', 'Incident response playbooks', 'Compliance dashboards'],
    techStack: ['Python', 'Go', 'Elasticsearch', 'React', 'Kafka'],
    relatedProductIds: ['prod-hci', 'prod-stratify', 'prod-scalerisk'],
    documents: [],
...

  {
    ...
    relatedProductIds: ['prod-cyberpod', 'prod-agentsight', 'prod-corerun'],
    documents: [
      {
        id: 'prd',
...

  {
    ...
    relatedProductIds: ['prod-cyberpod', 'prod-corerun-aigw'],
    documents: [],
  ...
  // ── L3: STRATEGY, GOVERNANCE & COMPLIANCE ──────────────────

  {
    id: 'prod-lighthouse',
    name: 'Lighthouse',
    shortName: 'Lighthouse',
    description: 'Enterprise portfolio intelligence platform — aggregates data across products, projects, and teams to give leadership real-time visibility into strategic performance and initiative health.',
    mission: 'Replace spreadsheet-driven portfolio reviews with a living intelligence layer that surfaces what matters to the right people.',
    icon: '🔭',
    phase: 'beta',
    status: 'active',
    layer: 'l3',
    ...
    websiteUrl: 'https://infinia.ai/',
    tags: ['portfolio', 'strategy', 'intelligence', 'leadership', 'analytics'],
    keyFeatures: ['Strategic OKR tracking', 'Initiative health scoring', 'Executive dashboards', 'Cross-team dependency mapping', 'AI-generated insights'],
    techStack: ['TypeScript', 'React', 'PostgreSQL', 'Python', 'D3.js'],
    relatedProductIds: ['prod-vulcan', 'prod-stratify'],
    documents: [],
    revenue: { mrr: 58000, arr: 696000, growthRate: 19.5, history: makeRevHistory(18000, 9) },
    usage: { dau: 180, mau: 640, totalUsers: 1100, growthRate: 24, history: makeUsageHistory(200, 10) },
    updates: [
      { date: '2026-03-25', title: 'AI insights engine', type: 'feature', description: 'Auto-surfaces lagging initiatives and at-risk OKRs with recommended actions.' },
      { date: '2026-02-12', title: 'Dependency mapping', type: 'feature', description: 'Visual cross-team dependency graph with critical path highlighting.' },
      { date: '2025-12-01', title: 'Beta launch', type: 'launch', description: 'Lighthouse opens to beta with 15 enterprise design partners.' },
    ],
  },

  {
    id: 'prod-vulcan',
    name: 'Vulcan Product Suite',
    shortName: 'Vulcan',
    description: 'Integrated project and product management suite purpose-built for software organisations — combines roadmapping, sprint management, and release coordination in a single sovereign platform.',
    mission: 'Give product and engineering teams a unified workspace that replaces fragmented tools with a single source of truth.',
    icon: '🌋',
    phase: 'ga',
    status: 'active',
    layer: 'l3',
    ...
    websiteUrl: 'https://infinia.ai/',
    tags: ['project-management', 'roadmapping', 'agile', 'product', 'enterprise'],
    keyFeatures: ['Visual roadmapping', 'Sprint planning & tracking', 'Release train management', 'Capacity planning', 'Stakeholder reporting'],
    techStack: ['TypeScript', 'React', 'PostgreSQL', 'Go', 'Redis'],
    relatedProductIds: ['prod-lighthouse', 'prod-stratify'],
    documents: [],
    revenue: { mrr: 145000, arr: 1740000, growthRate: 11.2, history: makeRevHistory(75000, 5.6) },
    usage: { dau: 890, mau: 3200, totalUsers: 7400, growthRate: 13, history: makeUsageHistory(2000, 6.5) },
    updates: [
      { date: '2026-03-18', title: 'AI sprint forecasting', type: 'feature', description: 'ML model predicts sprint completion probability based on team velocity.' },
      { date: '2026-02-05', title: 'Release train v2', type: 'feature', description: 'SAFe-compatible release train management with PI planning support.' },
      { date: '2026-01-10', title: 'Stakeholder portal', type: 'feature', description: 'External stakeholder view with curated roadmap and status updates.' },
    ],
  },

  {
    ...
    relatedProductIds: ['prod-scalerisk', 'prod-c3', 'prod-lighthouse'],
    documents: [],
...

  {
    ...
    relatedProductIds: ['prod-stratify', 'prod-lighthouse', 'prod-c3'],
    documents: [],
...

  {
    ...
    name: 'Finance Consolidation Engine',
    shortName: 'Finance Consol.',
    ...
    relatedProductIds: ['prod-xailon', 'prod-adi-chain', 'prod-effora'],
    documents: [],
  ...
  {
    id: 'prod-skillforge',
    name: 'Skill Forge HRMS',
    shortName: 'Skill Forge HRMS',
    description: 'AI-powered human resource management system that goes beyond traditional HRMS — it maps organisational skills, identifies gaps, and builds personalised learning paths to develop the workforce your strategy demands.',
...

  {
    ...
    name: 'Effora',
    shortName: 'Effora',
    description: 'Intelligent accounts payable and spend management platform — automates invoice processing, approval workflows, and payment execution while providing real-time spend visibility across the organisation.',
    mission: 'Make every dirham of company spend visible, controlled, and optimised — from invoice receipt to payment confirmation.',
    icon: '💸',
    phase: 'ga',
    status: 'active',
    layer: 'l4',
    ...
    websiteUrl: 'https://infinia.ai/',
    tags: ['finance', 'accounts-payable', 'spend-management', 'automation', 'procurement'],
    keyFeatures: ['AI invoice processing', 'Multi-level approval workflows', 'Spend analytics', 'Vendor management', 'Payment execution', 'ERP sync'],
    techStack: ['TypeScript', 'React', 'PostgreSQL', 'Go', 'Stripe'],
    relatedProductIds: ['prod-finance-engine', 'prod-adi-chain', 'prod-xailon'],
    documents: [],
    revenue: { mrr: 142000, arr: 1704000, growthRate: 18.6, history: makeRevHistory(65000, 8.8) },
    usage: { dau: 680, mau: 2400, totalUsers: 5200, growthRate: 22, history: makeUsageHistory(1400, 10) },
    updates: [
      { date: '2026-03-15', title: 'Payment automation', type: 'feature', description: 'Fully automated payment execution for approved invoices below threshold.' },
      { date: '2026-02-20', title: 'Spend heatmap', type: 'feature', description: 'Visual spend heatmap by vendor, category, and cost centre.' },
      { date: '2026-01-12', title: '3-way matching', type: 'feature', description: 'Automated PO, receipt, and invoice 3-way matching with exception routing.' },
    ],
  },
...

  {
    ...
    name: 'ADI Chain',
    shortName: 'ADI Chain',
    description: 'Blockchain-powered audit and document integrity platform — creates tamper-proof audit trails for financial records, contracts, and regulatory submissions using distributed ledger technology.',
    mission: 'Make every critical document cryptographically provable and every audit trail irrefutable — eliminating fraud and compliance uncertainty.',
    icon: '⛓️',
    phase: 'beta',
    status: 'active',
    layer: 'l4',
    ...
    foundedDate: '2024-06-01',
    websiteUrl: 'https://infinia.ai/',
    tags: ['blockchain', 'audit', 'compliance', 'documents', 'integrity'],
    keyFeatures: ['Immutable audit logs', 'Document hash anchoring', 'Smart contract workflows', 'Regulatory submission certification', 'Multi-party verification'],
    techStack: ['TypeScript', 'Solidity', 'Go', 'React', 'PostgreSQL'],
    relatedProductIds: ['prod-effora', 'prod-finance-engine', 'prod-stratify'],
    documents: [],
    revenue: { mrr: 68000, arr: 816000, growthRate: 26.5, history: makeRevHistory(18000, 12) },
    usage: { dau: 180, mau: 640, totalUsers: 1200, growthRate: 32, history: makeUsageHistory(300, 14) },
    updates: [
      { date: '2026-03-20', title: 'Smart contract library', type: 'feature', description: 'Pre-built smart contracts for procurement approvals and payment release.' },
      { date: '2026-02-08', title: 'Regulatory anchoring', type: 'feature', description: 'Certified document anchoring accepted by UAE regulatory authorities.' },
      { date: '2025-10-01', title: 'Beta launch', type: 'launch', description: 'ADI Chain opens to beta with 6 financial services design partners.' },
    ],
  },

  {
    ...
    description: 'AI-powered customer support operations platform that automates ticket routing, resolution, and knowledge management — enabling support teams to handle 3× the volume with the same headcount.',
  ...
  {
    id: 'prod-infinia-connect',
    name: 'Infinia Connect',
    shortName: 'Infinia Connect',
    description: 'Enterprise integration and API management platform — the connective tissue of the Infinia stack, enabling seamless data flows between all Infinia products and third-party systems with sovereign data handling.',
    mission: 'Eliminate integration debt by providing a single, governed platform for all data flows within and beyond the Infinia ecosystem.',
    icon: '🔗',
    phase: 'beta',
    status: 'active',
    layer: 'l4',
    ...
    websiteUrl: 'https://infinia.ai/',
    tags: ['integration', 'api-management', 'middleware', 'enterprise', 'connectivity'],
    keyFeatures: ['100+ pre-built connectors', 'Visual workflow builder', 'API gateway & versioning', 'Data transformation engine', 'Error handling & retry logic', 'Audit trail for all flows'],
    techStack: ['Go', 'TypeScript', 'React', 'Kafka', 'PostgreSQL'],
    relatedProductIds: ['prod-xailon', 'prod-harmony-crm', 'prod-effora'],
    documents: [],
    revenue: { mrr: 88000, arr: 1056000, growthRate: 30.2, history: makeRevHistory(22000, 14) },
    usage: { dau: 290, mau: 1050, totalUsers: 2200, growthRate: 36, history: makeUsageHistory(400, 16) },
    updates: [
      { date: '2026-03-18', title: '100 connector milestone', type: 'milestone', description: 'Infinia Connect reaches 100 pre-built connectors for enterprise systems.' },
      { date: '2026-02-20', title: 'Visual workflow builder', type: 'feature', description: 'Drag-and-drop workflow builder with conditional logic and branching.' },
      { date: '2025-12-01', title: 'Beta launch', type: 'launch', description: 'Infinia Connect opens to beta with API gateway and 60 connectors.' },
    ],
  },

  // ── L5: CUSTOMER FACING APPLICATIONS ───────────────────────

  {
    ...
    relatedProductIds: ['prod-esal', 'prod-adi-chain'],
    documents: [],
...

  {
    ...
    relatedProductIds: ['prod-finance-engine', 'prod-adi-chain'],
    documents: [],
...

  {
    ...
    relatedProductIds: ['prod-support-ops', 'prod-skillforge', 'prod-vulcan'],
    documents: [],
...

  {
    ...
    relatedProductIds: ['prod-actionly', 'prod-harmony-crm'],
    documents: [],
...
export const PRODUCTS_BY_LAYER = {
  ...
  l4: PRODUCTS.filter(p => p.layer === 'l4'),
  l5: PRODUCTS.filter(p => p.layer === 'l5'),
}
